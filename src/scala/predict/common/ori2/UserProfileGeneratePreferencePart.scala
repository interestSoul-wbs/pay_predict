...
object UserProfileGeneratePreferencePart {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 3 - data process
    val df_result = userProfileGeneratePreferencePartProcess(sixteenDaysAgo, 30, df_medias, df_plays)

    printDf("df_result", df_result)

    // 4 - save data
    saveUserProfileGeneratePreferencePart(df_result, partitiondate, license, "valid")
  }
  ...
  /**
    ...
    * @param df_result
    */
  def saveUserProfileGeneratePreferencePart(df_result: DataFrame, partitiondate: String, license: String, category: String) = {
