...
object UserProfileGeneratePreferencePartForUserpay {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df_plays = getProcessedPlayV2(partitiondate, license, vodVersion, sector, category)

    val df_medias = getProcessedMediasV2(processedMediasData, license)
    ...
    // 4 Save Data
    saveUserProfileGeneratePreferencePartV2(df_user_profile_pref, partitiondate, license, vodVersion, sector, category)
  }
